...
func TestName(t *testing.T) {
	c := New()
	if c.Name() != "jobspresso" {
		t.Errorf("Name() = %q; want \"jobspresso\"", c.Name())
	}
}
...
<rss version="2.0">
  <channel>
    ...
    <item>
      ...
      <link>https://jobspresso.co/job/2</link>
    </item>
  </channel>
</rss>`
	...
	if jobs[0].Company != "Jobspresso" {
		t.Errorf("company = %q; want \"Jobspresso\"", jobs[0].Company)
	}
	if !jobs[0].Remote {
		t.Error("expected remote=true for jobspresso")
	}
	if jobs[0].Provider != "jobspresso" {
		t.Errorf("provider = %q; want \"jobspresso\"", jobs[0].Provider)
	}
...
<rss version="2.0">
  <channel>
    <item><title></title><link>https://jobspresso.co/job/1</link></item>
    <item><title>Valid</title><link></link></item>
    <item><title>Go Engineer</title><link>https://jobspresso.co/job/3</link></item>
  </channel>
</rss>`
