	...
	}{
		{
			...
			scrape: func(_ context.Context, _, _ string, _ []string, _ bool) ([]scraper.BoardJob, error) {
				return []scraper.BoardJob{
					{Title: "Software Engineer", Company: "Paypal", Location: "Remote", ApplyURL: "https://example.com/jobs/1", Remote: true},
					{Title: "Engineer II", Company: "Walmart", Location: "Remote", ApplyURL: "https://example.com/jobs/2", Remote: true},
				}, nil
			},
			wantJobs: 2,
		},
